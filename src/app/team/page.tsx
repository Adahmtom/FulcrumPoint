    ...
    <div className="fn-overlay" onClick={onClose} role="dialog" aria-modal="true" aria-label="Founder's Note">
      <div className="fn-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="fn-body">
          ...
          <p>
            FulcrumPoint, as part of its Creating Shared Value (CSV) sustainability strategy, is committed to broadening access and opening doors for all, recruiting from underrepresented communities, championing second-chance hiring, and rebuilding pathways from high schools and technical institutions. By doing so, alongside the growing coalition working to address the skilled trades labor workforce shortage, we will reposition the skilled trades as a first-choice, high-value career—a path of dignity, promise, and possibility. Every person deserves the chance to discover their potential, to be empowered with skills that can change lives, and to choose a future that leads to the American dream. Together, let&apos;s build that future—one skill, one opportunity, one legacy at a time.
          </p>
        </div>
